classdef TestSPO1 < TestOSPOcomposer
    
    methods
        function obj = TestSPO1()
        ...
        function [] = consistent_tall(obj)
            ...
            alg = @(A, b) spo1(A, b, sampling_factor, alg_tol, iter_lim, smart_init, logging, seed);
            obj.run_consistent(ath, alg, alg_tol, 1e-6);
        ...
        function [] = consistent_lowrank(obj)
            % Test data generation.
            stream = MarlaRandStream(98743);
            m = 100;
            n = 10;
