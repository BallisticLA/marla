function[] = test_osid()
    ...
    test1.k = 29;
    test1.A = gen_test_mat(100, 30, test1.k, 0); 

    test2.k = 28;
    test2.A = gen_test_mat(100, 30, test2.k, 0); 

    test3.k = 3;
    test3.A = gen_test_mat(100, 30, test3.k, 0); 
...
function[] = test_simple_exact(test1, test2, test3)
    ...
    % osid1
    % Row IDs
    [M, P] = osid1(test1.A, 29, 0, 1, 0);
    run_osid_test(test1.A, M, P, 29, 0, 1e-12);
    [M, P] = osid1(test2.A, 28, 1, 1, 0);
    run_osid_test(test2.A, M, P, 28, 0, 1e-12);
    [M, P] = osid1(test3.A, 3, 0, 1, 0);
    run_osid_test(test3.A, M, P, 3, 0, 1e-12);
    % Column IDs
    [M, P] = osid1(test1.A, 29, 0, 1, 1);
    run_osid_test(test1.A, M, P, 29, 1, 1e-12);
    [M, P] = osid1(test2.A, 28, 1, 1, 1);
    run_osid_test(test2.A, M, P, 28, 1, 1e-12);
    [M, P] = osid1(test3.A, 3, 0, 1, 1);
    run_osid_test(test3.A, M, P, 3, 1, 1e-12);

    % osid2
    % Row IDs
    [M, P] = osid2(test1.A, 29, 0, 1, 0);
    run_osid_test(test1.A, M, P, 29, 0, 1e-12);
    [M, P] = osid2(test2.A, 28, 1, 1, 0);
    run_osid_test(test2.A, M, P, 28, 0, 1e-12);
    [M, P] = osid2(test3.A, 3, 0, 1, 0);
    run_osid_test(test3.A, M, P, 3, 0, 1e-12);
    % Column IDs
    [M, P] = osid2(test1.A, 29, 0, 1, 1);
    run_osid_test(test1.A, M, P, 29, 1, 1e-12);
    [M, P] = osid2(test2.A, 28, 1, 1, 1);
    run_osid_test(test2.A, M, P, 28, 1, 1e-12);
    [M, P] = osid2(test3.A, 3, 0, 1, 1);
    run_osid_test(test3.A, M, P, 3, 1, 1e-12);
end
...
function[] = test_simple_approx(test4, test5)
    ...
    run_osid_test(test4.A, M, P, 29, 1, 0.05);
    [M, P] = osid1(test4.A, 25, 4, 1, 1);
    run_osid_test(test4.A, M, P, 28, 1, 0.05);
    [M, P] = osid1(test4.A, 5, 5, 1, 0);
    run_osid_test(test4.A, M, P, 3, 0, 0.1);

    % Wide matrices.
    [M, P] = osid1(test5.A, 27, 3, 1, 1);
    run_osid_test(test5.A, M, P, 29, 1, 0.05);
    [M, P] = osid1(test5.A, 25, 4, 1, 1);
    run_osid_test(test5.A, M, P, 28, 1, 0.05);
